...
// Narrative camera waypoints — cinematic journey through rooms
const WAYPOINTS = [
  // Phase A — Entrance: approach, see character, pass through door
  { at: 0.00, pos: [0, 1.6, 10],    lookAt: [0, 1.5, 0],     fov: 50 },
  { at: 0.08, pos: [0, 1.6, 7],     lookAt: [0, 1.5, 0],     fov: 50 },
  { at: 0.12, pos: [0.6, 1.6, 5],   lookAt: [0, 1.5, 0],     fov: 50 }, // slight pan to see character
  { at: 0.18, pos: [0, 1.6, 3],     lookAt: [0, 1.5, 0],     fov: 50 }, // character grabs handle
  { at: 0.25, pos: [0, 1.6, -1],    lookAt: [0, 1.5, -5],    fov: 55 }, // through the door

  // Phase B — Dirty→Clean Room with workers
  { at: 0.30, pos: [0, 1.8, -5],    lookAt: [1, 1.5, -10],   fov: 52 },
  { at: 0.40, pos: [1.5, 1.7, -7],  lookAt: [-1, 1.5, -10],  fov: 50 }, // pan to see workers
  { at: 0.50, pos: [-1, 1.6, -9],   lookAt: [1, 1.3, -12],   fov: 50 }, // follow cleaning
  { at: 0.58, pos: [0, 1.6, -11],   lookAt: [0, 1.5, -14],   fov: 50 }, // approaching hallway
  { at: 0.65, pos: [0, 1.6, -15],   lookAt: [0, 1.5, -20],   fov: 55 }, // through archway

  // Phase C — Pristine Room
  { at: 0.70, pos: [0, 1.8, -18],   lookAt: [1, 1.2, -22],   fov: 52 },
  { at: 0.80, pos: [2, 1.6, -20],   lookAt: [0, 1.0, -22],   fov: 50 },
  { at: 0.90, pos: [3, 1.5, -21],   lookAt: [-0.5, 1.0, -23], fov: 48 },
...
// Reduce parallax during physical transitions
...
export default function CameraController() {
  ...
  useFrame((state, delta) => {
    ...
    // Reduce mouse parallax during transitions
